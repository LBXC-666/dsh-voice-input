window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    var css = [
      ...
      '.vi_flow-overlay[data-flow=blue]{background:linear-gradient(90deg,#0a84ff,#5ad1ff,#0a84ff);background-size:200% 100%;animation:vi_flow_blue 1.6s linear infinite}',
