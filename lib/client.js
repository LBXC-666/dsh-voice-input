window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    var css = [
      ...
      '.vi_aiHint{color:var(--dsw-alias-label-primary);font-weight:500;animation:vi_ai_hint_pulse 1.6s ease-in-out infinite}',
      '@keyframes vi_ai_hint_pulse{0%,100%{transform:translateY(0);opacity:.85}50%{transform:translateY(-2px);opacity:1}}',
      ...
      '.vi_aiButton{position:relative;border-color:transparent;animation:vi_ai_pop .45s var(--ds-ease-out),vi_ai_glow 2.4s ease-in-out .45s infinite}',
      ...
      '.vi_aiButton::after{content:"";position:absolute;inset:-4px;border-radius:999px;pointer-events:none;z-index:-1;background:conic-gradient(from var(--vi-ai-angle,0deg),rgba(255,0,76,.6),rgba(255,138,0,.55),rgba(255,230,0,.5),rgba(0,230,118,.55),rgba(0,176,255,.6),rgba(124,77,255,.55),rgba(255,0,76,.6));filter:blur(4px);opacity:.6;animation:vi_ai_aura 2.2s linear infinite}',
      ...
      '@keyframes vi_ai_glow{0%,100%{box-shadow:0 0 8px 2px rgba(255,0,76,.6),0 0 18px 6px rgba(255,138,0,.35)}25%{box-shadow:0 0 8px 2px rgba(255,230,0,.6),0 0 18px 6px rgba(0,230,118,.35)}50%{box-shadow:0 0 8px 2px rgba(0,176,255,.6),0 0 18px 6px rgba(0,230,118,.35)}75%{box-shadow:0 0 8px 2px rgba(124,77,255,.6),0 0 18px 6px rgba(0,176,255,.35)}}',
    ...
    var en = {
      ...
      optimizeHint: 'Click the ✨ button on the left to optimize this text',
    ...
    function VoiceInputButton(props) {
      ...
      } else if (showOptimize && !formatBusy && composerDraft.trim() !== '') {
        popover = h('div', { className: 'vi_pop vi_aiHint', role: 'status' },
          h('span', null, t('optimizeHint')),
        )
      }
