window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    var css = [
      ...
      '.vi_micButton::before{content:"";position:absolute;left:1px;top:8%;bottom:8%;width:2px;border-radius:2px;pointer-events:none;background:linear-gradient(180deg,transparent,rgba(255,255,255,.55),rgba(90,209,255,.5),transparent);opacity:.6;animation:vi_mic_edge_flow 2.6s ease-in-out infinite}',
      '@keyframes vi_mic_edge_flow{0%,100%{transform:translateY(-55%);opacity:.15}50%{transform:translateY(55%);opacity:.6}}',
      ...
      '.vi_aiButton:hover{background-image:conic-gradient(from var(--vi-crescent-angle,0deg),transparent 0deg 28deg,rgba(255,255,255,.6) 31deg,rgba(0,176,255,.35) 35deg,transparent 40deg,transparent 360deg);animation:vi_ai_crescent 1.6s linear infinite,vi_ai_glow 2.2s ease-in-out infinite}',
