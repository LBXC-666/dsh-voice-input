window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    var css = [
      ...
      '.vi_aiButton{position:relative;border-color:transparent;background-image:linear-gradient(110deg,transparent 25%,rgba(255,0,76,.22) 40%,rgba(255,230,0,.26) 45%,rgba(0,176,255,.26) 50%,rgba(124,77,255,.22) 55%,transparent 75%);background-size:250% 100%;animation:vi_ai_pop .45s var(--ds-ease-out),vi_ai_sheen 1.8s ease-in-out .6s infinite,vi_ai_glow 2.4s ease-in-out .45s infinite}',
      ...
      '@keyframes vi_ai_sheen{0%{background-position:120% 0}100%{background-position:-120% 0}}',
