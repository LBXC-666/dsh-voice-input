window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    var css = [
      ...
      '.vi_aiButton{position:relative;border-color:transparent;background-image:linear-gradient(105deg,transparent 30%,rgba(255,255,255,.38) 40%,rgba(255,0,76,.5) 45%,rgba(255,230,0,.55) 50%,rgba(0,176,255,.5) 55%,rgba(124,77,255,.45) 58%,rgba(255,255,255,.38) 63%,transparent 78%);background-size:230% 100%;animation:vi_ai_pop .45s var(--ds-ease-out),vi_ai_sheen 2.2s ease-in-out .6s infinite,vi_ai_glow 2.4s ease-in-out .45s infinite}',
      ...
      '@keyframes vi_ai_sheen{0%{background-position:130% 0}100%{background-position:-130% 0}}',
