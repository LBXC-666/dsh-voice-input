window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    var css = [
      ...
      '.vi_flow-overlay[data-flow=rainbow] .vi_flow-wave-a{background:linear-gradient(90deg,rgba(255,0,76,.32),rgba(255,138,0,.36),rgba(255,230,0,.32),rgba(0,230,118,.32),rgba(0,176,255,.36),rgba(124,77,255,.32),rgba(255,0,76,.32));background-size:220% 100%;animation:vi_flow_a 2.5s linear infinite}',
      ...
      '.vi_typing-host::after{content:"";position:absolute;top:4px;bottom:4px;left:-14%;width:150px;border-radius:999px;pointer-events:none;background:linear-gradient(90deg,transparent,rgba(255,0,76,.08),rgba(255,138,0,.1),rgba(255,230,0,.1),rgba(0,230,118,.08),rgba(0,176,255,.1),rgba(124,77,255,.08),transparent);filter:blur(10px);opacity:.32;animation:vi_typing_sweep 1.1s ease-in-out}',
      '@keyframes vi_typing_sweep{0%{left:-14%;opacity:.05;transform:scaleX(.75)}25%{opacity:.35;transform:scaleX(1)}100%{left:calc(100% - 150px);opacity:0;transform:scaleX(1.2)}}',
