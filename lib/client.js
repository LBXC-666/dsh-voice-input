window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    var css = [
      ...
      '.vi_aiButton{position:relative;border-color:transparent;background-color:var(--dsw-alias-bg-layer-1);background-image:conic-gradient(from var(--vi-crescent-angle,0deg),transparent 0deg 22deg,rgba(0,176,255,.35) 26deg,rgba(255,255,255,.9) 30deg,#fff 33deg,rgba(255,255,255,.9) 36deg,rgba(0,176,255,.35) 40deg,transparent 44deg,transparent 360deg);animation:vi_ai_pop .45s var(--ds-ease-out),vi_ai_crescent 2.2s linear .6s infinite,vi_ai_glow 2.4s ease-in-out .45s infinite}',
