window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    var css = [
      ...
      '.vi_flow-wave-a{background:conic-gradient(from var(--vi-angle,0deg),transparent 0deg 315deg,rgba(10,132,255,.85) 330deg,rgba(90,209,255,.9) 342deg,rgba(10,132,255,.2) 348deg,transparent 360deg);animation:vi_flow_spin 2.6s linear infinite}',
      '.vi_flow-wave-b{background:conic-gradient(from var(--vi-angle,0deg),transparent 0deg 205deg,rgba(0,120,220,.5) 220deg,rgba(0,176,255,.55) 232deg,transparent 244deg,transparent 360deg);animation:vi_flow_spin 3.8s linear infinite reverse}',
