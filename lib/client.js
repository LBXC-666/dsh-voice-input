window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    function VoiceInputButton(props) {
      ...
      // AI 优化期间（等待模型返回 + 打字机写回）：文本框内反复扫过流光，
      // 覆盖在现有文字之上，扫描带从左向右循环
