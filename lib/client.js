window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    var zh = {
      ...
      formatterTwoPassEnabled: '启用第二轮优化',
      formatterTwoPassEnabledHint: '关闭后，任何「一轮 + 二轮」模式只执行第一轮纠错。',
    ...
    var en = {
      ...
      formatterTwoPassEnabled: 'Enable second formatting round',
      formatterTwoPassEnabledHint: 'When off, any "round 1 + round 2" mode runs only the typo-fix round.',
