window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    var css = [
      ...
      '.vi_flow-wave-a{background:repeating-conic-gradient(from var(--vi-angle,0deg),rgba(10,132,255,.12) 0deg 16deg,rgba(10,132,255,.95) 16deg 22deg,rgba(90,209,255,.8) 22deg 26deg,rgba(10,132,255,.12) 26deg 48deg);animation:vi_flow_spin 2.6s linear infinite}',
      '.vi_flow-wave-b{background:repeating-conic-gradient(from var(--vi-angle,0deg),transparent 0deg 18deg,rgba(0,120,220,.7) 18deg 24deg,rgba(0,176,255,.5) 24deg 28deg,transparent 28deg 56deg);animation:vi_flow_spin 3.8s linear infinite reverse}',
