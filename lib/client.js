window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    var css = [
      ...
      '@keyframes vi_ai_glow{0%,100%{box-shadow:0 0 5px 1px rgba(255,0,76,.5),0 0 12px 3px rgba(255,138,0,.28)}25%{box-shadow:0 0 5px 1px rgba(255,230,0,.5),0 0 12px 3px rgba(0,230,118,.28)}50%{box-shadow:0 0 5px 1px rgba(0,176,255,.5),0 0 12px 3px rgba(0,230,118,.28)}75%{box-shadow:0 0 5px 1px rgba(124,77,255,.5),0 0 12px 3px rgba(0,176,255,.28)}}',
