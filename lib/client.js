window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    var css = [
      ...
      '.vi_aiButton:hover{background-image:conic-gradient(from var(--vi-crescent-angle,0deg),transparent 0deg 28deg,rgba(255,255,255,.95) 31deg,rgba(0,176,255,.55) 35deg,transparent 40deg,transparent 360deg);animation:vi_ai_crescent 1.6s linear infinite,vi_ai_glow 2.2s ease-in-out infinite}',
      '.vi_aiButton:hover::after{opacity:.75}',
